...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        v_layer = value_layer.permute(0, 2, 1, 3).contiguous()
        new_v_layer_shape = v_layer.size()[:-2] + (self.all_head_size,)
        v_layer = v_layer.view(*new_v_layer_shape)
        self.save_v(v_layer)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        embedding_output = alpha*embedding_output
